      ...
      <div className="relative flex overflow-x-hidden w-full group">
        ...
        <div className="flex animate-[marquee_30s_linear_infinite] whitespace-nowrap group-hover:[animation-play-state:paused]">
          {[...dummyLogos, ...dummyLogos, ...dummyLogos].map((logo, idx) => (
            <div
              key={idx}
              className="w-48 h-20 mx-6 bg-slate-50 border border-slate-100 rounded-2xl flex items-center justify-center grayscale opacity-50 hover:grayscale-0 hover:opacity-100 transition-all duration-300 shadow-sm"
            >
