...
export default function VolunteerIDCard({ volunteer, onClose }: VolunteerIDCardProps) {
  ...
  useEffect(() => {
    ...
    const qrData = `${baseUrl}/verify.html?id=${encodeURIComponent(volunteer.id)}&name=${encodeURIComponent(volunteer.fullName)}&phone=${encodeURIComponent(volunteer.mobileNumber)}`;
